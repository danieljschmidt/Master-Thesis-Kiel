\chapter{Proof of eqn. 2 in \citet{MarianoMurasawa2003}}\label{sec:mariano-murasawa}
...
% TODO: show that the approximation error is small for industrial production (???)